...
func TestNotification(t *testing.T) {
	cases := []testSt{
		...
		{
			url:               "https://example.com/?m=#SANTAIZI#",
			body:              `{"asd":"dsa"}`,
			reqMethod:         NotificationRequestMethodGET,
		...
		{
			url:               "https://example.com/?m=#SANTAIZI#",
			body:              `{"#SANTAIZI#":"#SANTAIZI#"}`,
			reqMethod:         NotificationRequestMethodPOST,
			reqType:           NotificationRequestTypeForm,
			expectURL:         "https://example.com/?m=" + msg,
			expectMethod:      http.MethodPost,
			expectContentType: reqTypeForm,
			expectBody:        "%23SANTAIZI%23=" + msg,
		},
		{
			url:               "https://example.com/?m=#SANTAIZI#",
			body:              `{"asd":"#SANTAIZI#"}`,
		...
		{
			url:               "https://example.com/?m=#SANTAIZI#",
			body:              `{"#SANTAIZI#":"#SANTAIZI#","Server":"#SERVER.NAME#","ServerIP":"#SERVER.IP#","ServerSWAP":"#SERVER.SWAP#"}`,
			reqMethod:         NotificationRequestMethodPOST,
			reqType:           NotificationRequestTypeForm,
			expectURL:         "https://example.com/?m=" + msg,
			expectMethod:      http.MethodPost,
			expectContentType: reqTypeForm,
			expectBody:        "%23SANTAIZI%23=" + msg + "&Server=ServerName&ServerIP=1.1.1.1&ServerSWAP=8888",
		},
	}
